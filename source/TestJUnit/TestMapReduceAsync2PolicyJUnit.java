...
public class TestMapReduceAsync2PolicyJUnit {
    ...
    public void testRRWordCount() {
        controller = new Controller<>(2, 3, 2048, 1024);
    ...
    private void testRRWordCount(String targetWord, Policy policy) {
        ...
        controller.registerAction("wordCount", wordCount, 150);

        System.out.println("Executing policy: " + controller.getPolicyManager());

        long startTime = System.currentTimeMillis();
        controller.invokeFunctionsPolicyManagerAsync(policy, functionsToAssign, pathsToAssign);
